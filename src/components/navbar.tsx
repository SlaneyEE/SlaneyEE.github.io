export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black shadow-md border-b border-purple-900 uppercase">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          <div className="flex items-center">
            <img src="/img/slaney-ee-xs.png" alt="Slaney EE" className="h-4 md:h-8" />
          </div>
